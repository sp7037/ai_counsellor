            ...
            <div class="flex min-w-0 flex-1 flex-col">
                <header class="flex items-center justify-between border-b border-zinc-800 px-4 py-3 lg:px-6">
                    <div class="flex items-center gap-3">
                        <flux:button class="lg:hidden" variant="ghost" size="sm" x-data x-on:click="document.getElementById('tenant-mobile-nav')?.classList.toggle('hidden')">Menu</flux:button>
                        <div>
                            <p class="text-xs uppercase tracking-wide text-zinc-500">Tenant Admin</p>
